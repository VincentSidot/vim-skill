...
" CDF functions
syn match skillcdfFunctions  "\v(\()@<=cdf[A-Z][a-zA-Z0-9_]+( )@="
syn match skillgeFunctions   "\v(\()@<=ge[A-Z][a-zA-Z0-9_]+( )@="
syn match skillhiFunctions   "\v(\()@<=hi[A-Z][a-zA-Z0-9_]+( )@="
syn match skillleFunctions   "\v(\()@<=le[A-Z][a-zA-Z0-9_]+( )@="
syn match skilldbefFunctions "\v(\()@<=d[bef][A-Z][a-zA-Z0-9_]+( )@="
syn match skillddFunctions   "\v(\()@<=dd[A-Z][a-zA-Z0-9_]+( )@="
syn match skillpcFunctions   "\v(\()@<=pc[A-Z][a-zA-Z0-9_]+( )@="
syn match skilltechFunctions "\v(\()@<=tech[A-Z][a-zA-Z0-9_]+( )@="
